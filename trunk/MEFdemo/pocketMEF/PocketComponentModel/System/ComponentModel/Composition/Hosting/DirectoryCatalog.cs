...
namespace System.ComponentModel.Composition.Hosting
{
    ...
    public partial class DirectoryCatalog : ComposablePartCatalog, INotifyComposablePartCatalogChanged, ICompositionElement
    {
        ...
        private IEnumerable<ComposablePartDefinition> _partsQuery;
        ...
        public void Refresh()
        {
            ...
            while (true)
            {
                ...
                this.DiffChanges (beforeFiles, afterFiles.ToArray(), out catalogsToAdd, out catalogsToRemove);
                ...
                using (var atomicComposition = new AtomicComposition())
                {
                    ...
                    using (new WriteLock(this._thisLock))
                    {
                        ...
                        this._partsQuery = this._catalogCollection.AsEnumerable().SelectMany(catalog => catalog.Parts);
        ...
        private IEnumerable<string> GetFiles()
        {
            ...
            return files.Select(file => file.ToUpper());
        }
        ...
        private static string GetFullPath(string path)
        {
            ...
            return IOPath.GetFullPath(path).ToUpper();
        }
